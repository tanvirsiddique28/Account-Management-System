...
public class cashOutput extends AppCompatActivity {
    // Database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagemenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent send = new Intent(cashOutput.this, MainActivity.class);
                startActivity(send);
            }
    ...
    String identitysave = "output";
    Double currentamount;
    Double newamount;
    Double total;
    public void saveCashOut(View view){
